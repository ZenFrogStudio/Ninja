...
#[tauri::command]
pub async fn read_wm_settings(
) -> anyhow::Result<crate::wm_settings::WmSettings, String> {
  crate::wm_settings::read_wm_settings()
    .await
    .map_err(|err| err.to_string())
}
...
pub async fn write_wm_settings(
  changes: Vec<crate::wm_settings::WmSettingChange>,
) -> anyhow::Result<(), String> {
  crate::wm_settings::write_wm_settings(changes)
    .await
    .map_err(|err| err.to_string())
}
