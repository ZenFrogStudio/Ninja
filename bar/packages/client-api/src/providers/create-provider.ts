...
import { createNinjaProvider } from './ninja/create-ninja-provider';
import type {
  NinjaProviderConfig,
  NinjaProvider,
} from './ninja/ninja-provider-types';
...
export function createProvider<T extends ProviderConfig>(
  ...
  switch (config.type) {
    ...
    case 'ninja':
    case 'glazewm':
      return createNinjaProvider(config) as any;
    case 'host':
